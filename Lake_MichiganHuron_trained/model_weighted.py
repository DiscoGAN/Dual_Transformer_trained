...
class auto_weighted(torch.nn.Module):
    ...
    def forward(self, dataset):
        ...
        dataset_future = dataset[:, self.cycle_num_before:self.cycle_num_before + self.cycle_num_later, 1:]  # Extract future data (excluding Lake Michigan-Huron water level)
